...
// Not: Bu dosya nodemailer kurulumundan sonra kullanılacak
...
class EmailService {
  ...
  async sendPasswordResetEmail(email, resetToken, userName) {
    try {
      ...
      const emailContent = {
        from: `"LeaveFlow" <${this.config.auth.user}>`,
        to: email,
      ...
      // E-posta gönderimi (nodemailer kurulumundan sonra aktif edilecek)
      console.log('E-posta gönderilecek:', emailContent);
      
      // Geliştirme için token'ı console'da göster
  ...
  async sendWelcomeEmail(email, userName) {
    try {
      ...
      console.log('Hoş geldin e-postası gönderilecek:', emailContent);
      return true;
    } catch (error) {
      console.error('E-posta gönderimi hatası:', error);
      throw error;
